...
class NewsAgencyTest {
    @Test
    void testEmptyAgencyLatestReleasedArticleIsNull() {
    ...
    @Test
    void testAddNullDoesNotThrowException() {
        NewsAgency newsAgency = new NewsAgency();

        newsAgency.addArticle(null);

        assertEquals(false, newsAgency.hasMoreArticles());
    }

    @Test
    void testEmptyAgencyHasMoreArticlesReturnsFalse() {
        NewsAgency newsAgency = new NewsAgency();
    ...
    @Test
    void testEmptyAgencyReleaseArticle() {
        NewsAgency newsAgency = new NewsAgency();
        ...
        assertEquals("No articles to release!", exception.getMessage());
    }

    @Test
    void testAddAndReleaseArticle() {
        NewsAgency newsAgency = new NewsAgency();
        ...
        newsAgency.addArticle(webArticle);
        ...
        assertEquals(false, newsAgency.hasMoreArticles());
        assertEquals(webArticle, newsAgency.getLatestReleasedArticle());
    }

    @Test
    void testReleaseTooManyArticlesThrowsException() {
        NewsAgency newsAgency = new NewsAgency();
        ...
        exception = assertThrows(NewsException.class, () -> {
            newsAgency.releaseArticle();
        });
    ...
    @Test
    void testReleaseInCorrectOrder() {
        ...
        for(Article currArticle : articles) {
            newsAgency.addArticle(currArticle);
        }
        ...
        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(podcastLiebesgschichten, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(podcastSpendenaktion, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(webArticleKiew, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(podcastSuperjuden, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(webArticleKennenlerntage, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(podcastStaatskuenstler, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(podcastOesterreichsRolle, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(webArticleHerbstferien, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(podcastZuSpaet, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(webArticleLeberkaese, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(true, newsAgency.hasMoreArticles());
        assertEquals(webArticleKonzerne, newsAgency.getLatestReleasedArticle());

        newsAgency.releaseArticle();

        assertEquals(false, newsAgency.hasMoreArticles());
        assertEquals(webArticleKiRegulierung, newsAgency.getLatestReleasedArticle());
    }
}